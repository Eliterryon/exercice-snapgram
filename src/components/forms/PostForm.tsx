...
import { useCreatePostMutation, useUpdatePostMutation } from "@/lib/react-querry/QueriesAndMutaiton"
...
const PostForm = ({ post, action } : PosteFormProps) => {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5x1">
                <FormField
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Textarea className="shad-textarea custum-scrollbar" {...field} />
                        </FormControl>
